...
class PathCircleSegment extends PathLineSegment
{
	...
	internal override function draw(target:*):void
	{
		...
		for (i = 0; i < n; i++)
		{
			a2 = a1 + span;
			a1 = a2 + span;
			target.curveTo(_center.x + Math.cos(a2) * rc, _center.y + Math.sin(a2) * rc, _center.x + Math.cos(a1) * radius, _center.y + Math.sin(a1) * radius);
		}
	}
