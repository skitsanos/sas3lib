...
package com.skitsanos.drawing
{
	...
	public class ICOImageData
	{
		...
		/**
		 * ãƒ“ãƒƒãƒˆãƒ•ã‚£ãƒ¼ãƒ«ãƒ‰èª­ã¿è¾¼ã¿
		 */
