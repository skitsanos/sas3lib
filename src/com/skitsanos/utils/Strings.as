...
package com.skitsanos.utils
{
	public final class Strings
	{
		 ...
		 *
		 * Strings.toInitials('Strings')		= s
		 * Strings.toInitials('Strings')		= su
		 * Strings.toInitials('StringsTest')	= sut
		 */
		 ...
		 *
		 * <pre>
		 * Strings.chompString(null, *)		 = null
		 * Strings.chompString('', *)		   = ''
		 * Strings.chompString('foobar', 'bar') = 'foo'
		 * Strings.chompString('foobar', 'baz') = 'foobar'
		 * Strings.chompString('foo', 'foo')	= ''
		 * Strings.chompString('foo ', 'foo')   = 'foo '
		 * Strings.chompString(' foo', 'foo')   = ' '
		 * Strings.chompString('foo', 'foooo')  = 'foo'
		 * Strings.chompString('foo', '')	   = 'foo'
		 * Strings.chompString('foo', null)	 = 'foo'
		 * </pre>
		 *
		...
		public static function reverse(source:String):String
		{
			...
			while (i > 0)
			{
				s += source.substring(i - 1, i);
				i--;
			}
			return s;
		}

		public static function randomizeString(newLength:uint = 8):String
		{
		 ...
		 *
		 * <pre>
		 * Strings.endsWith(null, *)					 = false
		 * Strings.endsWith(null, null)				 = false
		 * Strings.endsWith(*, null)					   = false
		 * Strings.endsWith('www.domain.com', 'com') = true
		 * </pre>
		 *
		 * @param str  the String to check, may be null
		 ...
		 *
		 * <pre>
		 * Strings.startsWith(null, *)					 = false
		 * Strings.startsWith(null, null)				 = false
		 * Strings.startsWith(*, null)					   = false
		 * Strings.startsWith('www.domain.com', 'www.')	= true
		 * </pre>
		 *
		 * @param str  the String to check, may be null
