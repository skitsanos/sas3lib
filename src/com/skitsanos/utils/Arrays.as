/**
 * @author Adobe Macromedia Software LLC
 */
package com.skitsanos.utils
{
	...
	public class Arrays
	{
		 ...
		 * @return
		 */
		public static function enumerate(source:Array):Array
		{
			var result:Array = [];

			for each(var key:* in source)
			{
				result.push(key);
			}
		 ...
		 * @return
		 */
		public static function findByKey(source:Array, key:String):*
		{
			for each(var arrkey:* in source)
			{
				if (key == arrkey)
				{
					return source[arrkey];
				}
			}
			return null;
		}
		...
		public static function exists(a:Array, x:*):Boolean
		{
